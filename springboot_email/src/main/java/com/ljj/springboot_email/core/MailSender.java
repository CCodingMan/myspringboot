package com.ljj.springboot_email.core;

import com.ljj.springboot_email.entity.MailEntity;
import com.ljj.springboot_email.enums.MailContentTypeEnum;
import com.ljj.springboot_email.utils.PropertiesUtil;
...
public class MailSender {
    ...
    public void send() throws Exception{
        ...
        if(mailEntity.getTitle() == null || mailEntity.getTitle().trim().length() == 0){
            throw new Exception("邮件标题未设置，请调用title方法设置");
        }
